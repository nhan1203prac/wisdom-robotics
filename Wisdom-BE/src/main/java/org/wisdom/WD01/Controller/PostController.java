...
public class PostController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<PostResponse>>> getAllActivePost(
        ...
        PageResponse<PostResponse> postPage = postService.getAllActivePost(page, size);
    ...
    public ResponseEntity<ApiResponse<PostStatResponse>> toggleStatus(@PathVariable Long id) {
        PostStatResponse stat = postService.togglePostStatus(id);
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Update post status successful", stat)
        );
    }
